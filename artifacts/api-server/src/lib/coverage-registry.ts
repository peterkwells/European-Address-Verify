...
export const REGISTRY: Record<string, CountryEntry> = {
  ...
  GB: {
    ...
    legal_risk_notes:
      ...
      "1. **Royal Mail PAF — commercial monopoly on postcodes**: The Postcode Address File is the definitive UK address database and is commercially licensed by Royal Mail. Use without a licence is a breach of copyright; unlicensed scraping, copying, or redistribution has been subject to legal action. Licences are tiered by use case and volume and typically cost several thousand pounds per year at minimum.\n\n" +
      "2. **OS AddressBase — address attributes remain commercial**: UPRN identifiers themselves became open data under the Open Government Licence in 2020. However, the address *attributes* linked to those identifiers — street name, locality, postcode, coordinates — come from OS AddressBase, which is commercially licensed for private-sector use. Publishing a usable address record (UPRN + address fields) derived from AddressBase without a licence is where the legal risk lies.\n\n" +
