...
export const REGISTRY: Record<string, CountryEntry> = {
  ...
  GB: {
    ...
    legal_risk: "medium",
    legal_risk_notes:
      "UK address data carries legal risk for three distinct but overlapping reasons:\n\n" +
